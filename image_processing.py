...
class Visualodo:
	...
	def process_img(self):
		...
		while globals.running:
			if globals.read_flag == False:
				...
				res = self.odo.process(image, globals.image_time_read, prior, cam_q)
	...
	def save_img(self, image, totalframe, res, process_time):
		...
		img_data_meta = {"Pixel clock (pixel/s)": globals.read_pixclk,
		...
		with open("/home/root/meta/meta%d.json"%totalframe, 'w') as json_file:
			json.dump(img_data_meta, json_file, indent=4)
